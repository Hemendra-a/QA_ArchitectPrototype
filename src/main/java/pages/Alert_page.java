...
public class Alert_page extends BaseLib {
	public  Alert_page() {
	...
	public void clickonclickmealert() {
		...
		clickmealert.click();
		factory.DriverManager.getDriver().switchTo().alert().accept();
	}
	...
	public void clickonmypromt() {
		...
		factory.DriverManager.getDriver().switchTo().alert().sendKeys("hemendra");
		factory.DriverManager.getDriver().switchTo().alert().accept();
	}

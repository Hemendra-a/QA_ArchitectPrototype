...
public class Datapicker_page extends BaseLib {
	...
	public void clickonselectdate() {
		...
		((JavascriptExecutor) factory.DriverManager.getDriver())
				.executeScript("document.getElementById('datePickerContainer').removeAttribute('readonly',0);"); // Enables
																													// the
																													// from
																													// date
																													// box
